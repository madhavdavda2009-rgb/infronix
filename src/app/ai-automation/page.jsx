  ...
  return (
    <>
      <main className="w-full pt-28 md:pt-32" id="main-content">
        <section className="relative w-full min-h-[560px] md:min-h-[700px] flex items-center bg-navy-muted overflow-hidden pt-20 pb-12" aria-label="AI Automation Services">
          <img
            src="/hero_bg.webp"
