"use client";
import { Warning, ArrowsClockwise, Key, SignOut, MagnifyingGlass, Tray, Pencil, Trash, X, PaperPlaneTilt, Users } from "@phosphor-icons/react";
...
export default function AdminDashboard() {
  const [activeTab, setActiveTab] = useState('consultations'); // 'consultations' | 'outreach'
    ...
    <>
      ...
      <div className="min-h-screen bg-navy-muted text-surface flex flex-col pt-24 pb-16">
          ...
          <div className="max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <button
                ...
                className="px-4 py-2.5 bg-red-950/60 hover:bg-red-900/80 border border-red-500/60 text-red-100 text-xs uppercase font-label-caps tracking-widest transition-colors flex items-center gap-2 cursor-pointer font-bold"
              >
        ...
        <main className="max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop flex-grow w-full">
          ...
          {/* TAB 2: OUTREACH & EMAIL AUTOMATION */}
          {activeTab === 'outreach' && (
            <OutreachDashboard showToast={showToast} />
          )}

          {/* TAB 1: CLIENT CONSULTATIONS */}
          {activeTab === 'consultations' && (
            <>
        ...
        {showPasswordModal && (
          <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
            <div className="bg-slate-950 border border-champagne-light/40 w-full max-w-md shadow-2xl overflow-hidden">
              ...
              <div className="p-6">
                {passwordError && (
                  <div className="mb-4 p-3 bg-red-950/70 border border-red-500/60 text-red-200 text-xs flex items-center gap-2 font-medium">
                    <Warning className="text-red-400 text-base shrink-0" weight="bold" />
